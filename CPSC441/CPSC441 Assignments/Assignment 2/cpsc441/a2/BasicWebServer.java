...
public abstract class BasicWebServer extends Thread {
	...
	/**
	 * Constructor to initialize the server You may override this method if needed
	 * 
	 ...
	 * 
	 * open server socket while (!shutdown) accept client connection start a new
	 * worker thread to process client request
	 *
	 */
